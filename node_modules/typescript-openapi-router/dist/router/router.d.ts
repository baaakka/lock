 ...
 */
import { Request, Response, StatusCode } from "..";
export declare class Router {
    ...
    private getMockData;
    handleEvent: (request: Request<any>) => Promise<Response<any>>;
    getApiDoc: (version: string) => any;
    private executeMiddlewareBefore;
    private executeMiddlewareAfter;
